...
const SHOTS = [
  ...
  ['07-west-stair-hall', { x: ft(-30), y: 0, z: ft(15.5), yaw: -1.5708, pitch: 0.02 }],
  ...
  ['16-upper-west', { x: ft(-39), y: ft(17.33), z: ft(34), yaw: 0, pitch: 0.0 }],
  ['17-upper-center', { x: ft(-14), y: ft(17.33), z: ft(-10), yaw: 0.4, pitch: 0.02 }],
  ['18-upper-east', { x: ft(39), y: ft(17.33), z: ft(34), yaw: 0, pitch: 0.0 }],
  ['19-indians', { x: ft(-30), y: 0, z: ft(0), yaw: -2.2, pitch: 0.02 }],
  ['20-americana', { x: ft(30), y: 0, z: ft(0), yaw: 2.2, pitch: 0.02 }],
