 ...
 *
 * Carried over from Final Rental, which is the right call: it is forty
 * lines, it has no dependencies, and the only thing it has to do is hand
 * files over with the correct content type.
 *
...
http.createServer(function (req, res) {
  ...
  console.log('');
  console.log('  COUNTY LINE  ->  http://localhost:' + PORT);
